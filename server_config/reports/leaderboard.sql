...
$SQL$
    ...
    SELECT  json_agg(json_build_object('position', attributes->>'position', 'org_name', attributes->>'org_name', 'distance_miles', attributes->>'distance_miles', 'distance_km',attributes->>'distance_km', 'date', to_char((attributes->>'dateTime')::TIMESTAMP, 'DD/MM/YYYY HH24:MM'))) FROM ng_adventuresyndicate.tracker_points
